...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'InvoiceSales', 'user' => 'root', 'password' => 'rootpassword', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Sales/SalesBundle/Entity'))), 'Sales\\SalesBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('SalesBundle' => 'Sales\\SalesBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0f46195238b3eab3161a68ae487350665e7c5d326eaefb6128cfc86005e600d9');
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('symfony.angular');
        $a->setPassword('react+ionic');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Sales/SalesBundle/Resources/views'), 'Sales');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('7c6f28e89875cd27cb642084030bca09e64aa0e5');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('571a1db66a9f79.17026112')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SalesBundle' => 'Sales\\SalesBundle\\SalesBundle',
            ...
            'secret' => '7c6f28e89875cd27cb642084030bca09e64aa0e5',
            'locale' => 'en',
            ...
            'kernel.secret' => '7c6f28e89875cd27cb642084030bca09e64aa0e5',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'symfony.angular',
            'swiftmailer.mailer.default.transport.smtp.password' => 'react+ionic',
