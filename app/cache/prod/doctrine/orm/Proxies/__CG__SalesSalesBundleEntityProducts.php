 ...
 */
class Products extends \Sales\SalesBundle\Entity\Products implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Sales\\SalesBundle\\Entity\\Products' . "\0" . 'id', '' . "\0" . 'Sales\\SalesBundle\\Entity\\Products' . "\0" . 'description', '' . "\0" . 'Sales\\SalesBundle\\Entity\\Products' . "\0" . 'amount', '' . "\0" . 'Sales\\SalesBundle\\Entity\\Products' . "\0" . 'invoice');
        }
