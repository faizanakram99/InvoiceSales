...
namespace Proxies\__CG__\Sales\SalesBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Invoice extends \Sales\SalesBundle\Entity\Invoice implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Sales\\SalesBundle\\Entity\\Invoice' . "\0" . 'id', '' . "\0" . 'Sales\\SalesBundle\\Entity\\Invoice' . "\0" . 'number', '' . "\0" . 'Sales\\SalesBundle\\Entity\\Invoice' . "\0" . 'address', '' . "\0" . 'Sales\\SalesBundle\\Entity\\Invoice' . "\0" . 'date', '' . "\0" . 'Sales\\SalesBundle\\Entity\\Invoice' . "\0" . 'products');
        }
